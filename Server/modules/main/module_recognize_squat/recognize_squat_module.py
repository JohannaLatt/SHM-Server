...
class RecognizeSquatModule(AbstractMirrorModule):
    ...
    def user_skeleton_updated(self, user):
        ...
        if self.is_ready_to_squat():
            ...
            if self.threshold_movement_in_y is None:
                ...
                print(self.threshold_movement_in_y)

            # At the very beginning of the squat, save starting position
            if not self.ready_to_squat:
    ...
    def calculate_user_thresholds(self):
        #TODO:
        pass
